...
class Vendor extends Person {
  ...
  sellTo = (customer, numberOfIceCreams) => {
    ...
    const total_cost = numberOfIceCreams * this.price;
    this.wallet.credit(total_cost);
    customer.wallet.debit(total_cost);
  };
}
...
class Customer extends Person {
  // implement Customer!
  wallet = new Wallet(10); //will overwrite the person's wallet
